...
export default function StatsBar() {
  return (
    <div style={{ borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", display: "grid", gridTemplateColumns: "repeat(4, 1fr)" }}>
      {STATS.map(({ num, label }, i) => (
        <div key={label} className="vt-stat-item" style={{ padding: "44px 40px", textAlign: "center", borderRight: i < 3 ? "1px solid var(--border)" : "none" }}>
